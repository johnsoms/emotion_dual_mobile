...
public class SentimentAnalyzer : MonoBehaviour
{
	...
	private string _username = "99fe37fa-70ce-4c77-bfb1-64e0c101e92e";
	private string _password = "X8dAVI1MzMcM";
    ...
    void Start()
    {
        ...
        Credentials naturalLanguageUnderstandingCredentials = new Credentials()
        {
			...
			Username = "82d11654-bafa-4592-836d-e656cd823ee9",
			Password = "bq7ptpWAdPkX",
