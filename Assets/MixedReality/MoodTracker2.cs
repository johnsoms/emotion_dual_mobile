...
public class MoodTracker2 : MonoBehaviour {
...
//		gameObject.transform.rotation = uiManager.emojiOrientation;
		gameObject.transform.Rotate(new Vector3(uiManager.GetRotation2() - currRotationX,0f,0f));
		currRotationX = uiManager.GetRotation2 ();
		//Update mood-cube color
//		Color moodColor = uiManager.GetMoodTrackerColor();
//		moodTrackerRenderer.material.color = moodColor;
		Material emoji = uiManager.GetMoodTrackerEmoji2();
