...
namespace Affdex2
{
    ...
    public class Detector : MonoBehaviour
    {
        ...
        /// </summary>
        public ImageResultsListener2 Listener
        {
            get
            {
                if (listener == null)
                {
                    listener = (ImageResultsListener2)GameObject.FindObjectOfType(typeof(ImageResultsListener2));
                }
        ...
        private ImageResultsListener2 listener;
