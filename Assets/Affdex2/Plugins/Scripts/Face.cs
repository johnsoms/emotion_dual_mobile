...
namespace Affdex2
{
    ...
    public class Face
    {
        ...
        public override string ToString()
        {
            ...
            {
                s += String.Format("{0} : {1:F2}\n", (Affdex2.Expressions)i, Expressions[(Affdex2.Expressions)i]);
            }
            s += "Emotions\n";
            for(int i = 0; i < Emotions.Count; i++)
            {
                s += String.Format("{0} : {1:F2}\n", (Affdex2.Emotions)i, Emotions[(Affdex2.Emotions)i]);
            }
            return s;
        }
    }
